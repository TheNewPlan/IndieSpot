...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { album: @music.album, band: @music.band, genre: @music.genre, release: @music.release, song: @music.song } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { album: @music.album, band: @music.band, genre: @music.genre, release: @music.release, song: @music.song } }
